              ...
              Positioned(
                ...
                child: Consumer<FavoritesManager>(
                  builder: (context, favoritesManager, child) {
                    final isFavorite =
                        favoritesManager.isFavorite(widget.recipe);
                    return IconButton(
                      icon: Icon(
                      ...
                      onPressed: () {
                        if (isFavorite) {
                          favoritesManager.removeFavorite(widget.recipe);
                        } else {
                          favoritesManager.addFavorite(widget.recipe);
                        }
                      },
                    );
                  },
          ...
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  buildIngredientRow(widget.recipe.ingredients![index]),
            ),
          ),
          Container(
            padding: const EdgeInsets.all(10.0),
        ...
        children: [
          Expanded(
            child: ListView.builder(
              ...
              itemBuilder: (context, index) =>
                  buildDirectionRow(index, widget.recipe.instructions![index]),
            ),
          ),
        ],
      ),
