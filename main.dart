...
void main() async {
  ...
  final isar =
      await Isar.open([RecipeSchema, MealPlanSchema], directory: dir.path);
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          BottomNavigationBarItem(
              label: "Recipes",
              icon: SizedBox(
                  height: 40.0, child: Image.asset("icons/recipe.png"))),
          BottomNavigationBarItem(
              label: "Favorites",
              icon: SizedBox(
                  height: 40.0, child: Image.asset("icons/favorite.png"))),
        ],
      ),
    );
  }
